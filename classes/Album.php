...
class Album {
     ...
     * @param string|null $release_datum De releasedatum van het album.
    ...
    public function save(PDO $db): void
    {
        ...
        $stmt->bindParam(':releaseDatum', $this->release_datum);
    ...
    {
        $this->release_datum = $releaseDatum;
    }
